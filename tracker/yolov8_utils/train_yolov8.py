...
def main(args):
    ...
    # model = YOLO('/data/zoujian/Detect_tracking/Yolov7-tracker-2/weights/yolov8n.pt') # 2024年9月28日
    ...
    model = YOLO('/data/zoujian/packages/ultralytics/ultralytics/cfg/models/v8/yolo8s_MultiscaleChanModule.yaml') # 2024年11月28日 2024年12月26日 2025年1月6日 2025年7月24日
