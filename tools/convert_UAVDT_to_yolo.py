...
DATA_ROOT = '/data1/zhangwei/track_dataset/UAVDT2/'
...
def process_train_test(seqs: list, frame_range: dict, cat_id: int = 0, split: str = 'trian') -> None:
    ...
    for seq in seqs:
        ...
        img_dir = osp.join(DATA_ROOT, 'UAV-benchmark-M', seq, '')  # 图片路径
        ...
        name = seq + '_gt.txt'
        ann_of_seq_path = os.path.join('/data1/zhangwei/track_dataset/UAVDT2/UAV-benchmark-MOTD_v1.0/GT', name) # GT文件路径
